...
export async function logAIUsage({
 ...
 const reasoning=typeof reasoning_tokens==='number'&&Number.isFinite(reasoning_tokens)&&reasoning_tokens>=0?Math.floor(reasoning_tokens):null;
 ...
 try{
  await pool.query(`
   INSERT INTO ai_usage_events(
    ...
    attempt,input_tokens,output_tokens,reasoning_tokens,total_tokens,latency_ms,finish_reason,
  ...
  `,[
   ...
   attempt,input,output,reasoning,total,latency_ms,finish_reason,http_status,Boolean(success),retry_reason,
