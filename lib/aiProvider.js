...
const OUTPUT_MAX=Math.min(720,MODEL.max_completion_tokens||720);
...
c is confidence from 0-100 for the COMPLETE name, phone and pairing.
...
async function safeLog(data){
 try{return await logAIUsage(data)}catch{return null}
}
