...
function deterministicPlan(input){
 ...
 if(/how is the organization doing|how are we doing|state of the organization|organization health|how are things going|what have you noticed|what did you notice|anything i missed|what am i missing|surprise me|show me something interesting/.test(text))return{goal:'view_aria_director_briefing',confidence:.99,steps:[{capability:'get_director_briefing',person_name:null,parameters:{limit:8}}]};
