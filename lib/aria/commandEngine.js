...
function deterministicPlan(input){
 ...
 if(/walk me through.*briefing|today.?s briefing|briefing|what matters most|what matters today|how is the organization doing|how are things|state of the organization|what should i know|what do i need to know|brief me|catch me up/.test(text))return{goal:'brief current organization state',confidence:1,steps:[{capability:'get_director_briefing',person_name:null,parameters:{limit:8}}]};
