...
export async function getDirectorBriefing(organizationId,{limit=8}={}) {
  ...
  const result={
    ...
    decisions:{
      ...
      learning_focus:insight.kind==='learning_gap'?insight.title:'Keep collecting human corrections and outcomes so future recommendations become organization-specific.'
    },
    evidence:{
      primary:[
