...
const INTELLIGENCE_EVENTS=new Set(['PERSON_CREATED','PERSON_UPDATED','PERSON_INFORMATION_UPDATED','PARTICIPATION_CONFIRMED','CARE_FEEDBACK','PERSON_CONTEXT_ADDED','COMMUNICATION_PREFERENCE_CHANGED','FOLLOW_UP_RESPONDED_POSITIVELY','FOLLOW_UP_RESPONDED_NEGATIVELY','FOLLOW_UP_REQUESTED_HELP','FOLLOW_UP_REQUESTED_NO_CONTACT']);
