...
export async function setPersonMemory({
 ...
 sourceEventId=null,createdBy=null,actorRole=null,validFrom=null,validUntil=null,metadata={}
},client=null){
 ...
 const result=await db.query('INSERT INTO person_memory(organization_id,person_id,memory_type,memory_key,content,confidence,source_event_id,source,active,metadata,is_current,evidence_kind,verification_status,valid_from,valid_until,created_by,actor_role,verified_at,supersedes_id) VALUES($1,$2,$3,$4,$5,$6,$7,$8,true,$9,true,$10,$11,COALESCE($12,NOW()),$13,$14,$15,$16,$17) RETURNING *',[organizationId,personId,memoryType,memoryKey,incoming,clamp(confidence),sourceEventId||null,source,obj(metadata),evidenceKind,verificationStatus,validFrom||null,validUntil||null,createdBy||null,actorRole||null,verificationStatus==='verified'?new Date().toISOString():null,current.rows[0]?.id||null]);
...
export async function setOrganizationMemory({
 ...
 verificationStatus='reported',source='human',sourceEventId=null,createdBy=null,validFrom=null,validUntil=null,metadata={}
},client=null){
