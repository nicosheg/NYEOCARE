...
export async function getOrganizationContext({organizationId,viewerId}){
 ...
 const [recentChanges,attentionSummary]=await Promise.all([getOrganizationChanges(organizationId,{days:30,limit:20}),getAttentionSummary(organizationId,{limit:8})]);
