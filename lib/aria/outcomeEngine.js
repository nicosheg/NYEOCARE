...
export async function recordOutcome(orgId,personId,outcomeType,outcomeScore=null,actionId=null,evidence={},actorId=null,feedbackId=null,sourceEventId=null){
 ...
 const result=await pool.query(`
  ...
  RETURNING *
 `,[orgId,personId,actionId,actionType,outcomeType,outcomeScore,evidence&&typeof evidence==='object'?evidence:{},actorId,feedbackId,sourceEventId?1:null,sourceEventId]);
