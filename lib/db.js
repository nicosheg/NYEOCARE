...
const pool=new Pool({connectionString,ssl:{rejectUnauthorized:false},family:4,max:4,idleTimeoutMillis:5000,connectionTimeoutMillis:3000,keepAlive:true,allowExitOnIdle:true,maxUses:500});
