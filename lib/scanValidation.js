...
function reasonInfo(reasons){
 const map={
  ...
  too_many_phone_numbers:['More than two phone numbers were found for this person.','Check the original row and keep only the numbers actually assigned to this person.'],
  name_needs_verification:['The name needs checking.','Check the original register and correct the name if necessary.'],
  phone_missing:['No phone number was safely read.','Check whether a phone number is visibly assigned to this person.'],
  duplicate_in_scan:['This person appears more than once in this scan.','Confirm which row should be remembered.']
 };
