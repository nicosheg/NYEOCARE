...
.mainContent{min-height:100dvh;padding-bottom:env(safe-area-inset-bottom)}.mainContent>main[style*="100dvh"]{height:auto!important;min-height:calc(100dvh - 80px)!important;overflow:visible!important}.mainContent>main[style*="100dvh"] .coming{position:relative!important;left:auto!important;right:auto!important;bottom:auto!important;margin:38px auto 0!important}
@media(max-width:380px){.mainContent>main[style*="100dvh"]{padding-left:15px!important;padding-right:15px!important}.ariaNavInner{transform:scale(.92)}}@media(max-height:700px){.mainContent>main[style*="100dvh"]{padding-bottom:112px!important}.mainContent>main[style*="100dvh"] .coming{margin-top:28px!important}}
...
@keyframes nyLivingTruthA{0%,100%{transform:translate3d(0,0,0) scale(1) rotate(0deg);border-radius:48% 52% 55% 45%}25%{transform:translate3d(5px,-3px,0) scale(1.08,.92) rotate(18deg);border-radius:58% 42% 46% 54%}50%{transform:translate3d(1px,4px,0) scale(.91,1.08) rotate(42deg);border-radius:43% 57% 60% 40%}75%{transform:translate3d(-4px,1px,0) scale(1.04,.96) rotate(70deg);border-radius:54% 46% 42% 58%}}@keyframes nyLivingTruthB{0%,100%{transform:translate3d(0,0,0) scale(1) rotate(0deg);border-radius:55% 45% 48% 52%}25%{transform:translate3d(-4px,4px,0) scale(.9,1.08) rotate(-25deg);border-radius:43% 57% 55% 45%}50%{transform:translate3d(4px,1px,0) scale(1.1,.9) rotate(-55deg);border-radius:60% 40% 42% 58%}75%{transform:translate3d(1px,-4px,0) scale(.96,1.04) rotate(-80deg);border-radius:46% 54% 58% 42%}}
