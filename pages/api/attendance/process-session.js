...
export default withAdmin(async function handler(req,res){
 ...
 try{
  const s=await pool.query('SELECT id,status,aria_processing_status,aria_processing_started_at FROM sessions WHERE id=$1 AND organization_id=$2 LIMIT 1',[session_id,orgId]);
