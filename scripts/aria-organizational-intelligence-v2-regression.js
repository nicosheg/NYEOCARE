...
const checks=[
 ...
 ['Voice synthesis is behind the same budget guard',files.gateway.includes("reserveBudget(organizationId,purpose,TTS_MODEL_KEY)")&&files.gateway.includes("confirmReservation(reservationId,reservationCost)")],
