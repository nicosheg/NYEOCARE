...
const checks=[
 ...
 ['Review transaction releases connection before post-commit work',has('pages/api/review/resolve.js',"db.release();released=true;await learn(pool")&&has('pages/api/review/resolve.js',"await pool.query(`INSERT INTO timeline_events")&&!reviewResolve.includes('finally{db.release()}')],
