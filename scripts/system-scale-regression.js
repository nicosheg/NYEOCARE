...
const checks=[
 ...
 ['People API uses keyset cursor',has('pages/api/people.js','base64url')&&has('pages/api/people.js','next_cursor')&&has('pages/api/people.js','new_rank')&&has('pages/api/people.js','truth_rank')&&has('sort_name')&&has('next_cursor')],
